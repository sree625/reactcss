...
import home from "./productImages/home.png";
import sofa from "./productImages/sofa.png";
        ...
        return (
          <div className={classes.product_card} key={item.id}>
            ...
            <div className={classes.product_info}>
              ...
              <p> {item.text}</p>
              <span className={classes.price}> Rp {item.price}</span>
              {!!item.maxprice && (
                <span className={classes.maxprice}> Rp {item.maxprice}</span>
              )}
            </div>
